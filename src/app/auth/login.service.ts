...
export class LoginService {
  ...
  constructor(
    ...
    this.countries$ = this.db.collection('Countries', ref => ref.orderBy('countryName', 'asc')).valueChanges();
    this.tweets$ = this.db.collection('Tweets', ref => ref.orderBy('tweetDate', 'desc')).valueChanges();
    this.news$ = this.db.collection('News', ref => ref.orderBy('newsDate', 'desc')).valueChanges();
    this.roles$ = this.db.collection('Roles', ref => ref.orderBy('roleName', 'asc')).valueChanges();
    this.userList$ = this.db.collection('Users', ref => ref.orderBy('role', 'asc')).valueChanges();
